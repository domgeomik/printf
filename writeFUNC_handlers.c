...
length, dom_Emma, extra_ch));
}
/**
* write_num - Write  Numbers Using  Bufffers
* @ind: Index  which Number Starts on the Buffer
* @buffer: Buffer
* @flags: Flags
* @width: width
...
* @is_negative: Number indicator if Negative
* @ind: Index which Number Starts  the Buffer
...
/**
* write_pointer - Write a Address Memory
